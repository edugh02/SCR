...
width = 25;     
height = 25;
resolution = 20; %20 pixeles por metro
map = occupancyMap(width, height, resolution);  %30-30-20?
map.GridLocationInWorld=[-5, -10];   %(-4, -4)?  %Definir nuestra posición inicial (0,0)
%% 
...
while(1)
    ...
    angles = msg_laser.readScanAngles;      %También se puede hacer usando 'scans=lidarScan(msg_laser);'
