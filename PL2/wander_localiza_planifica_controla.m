...
while(1)
 ...
 if (estimatedCovariance(1,1)<0.01 && estimatedCovariance(2,2)<0.01 && estimatedCovariance(3,3)<0.01)
    ...
    msg_vel.Linear.X = 0;	%Indicamos que la velocidad lineal en el eje X sea 0.1
    msg_vel.Linear.Y = 0;
    msg_vel.Linear.Z = 0;
    msg_vel.Angular.X = 0;
    msg_vel.Angular.Y = 0;
...
while(1)
    ...
    %y angular
    [lin_vel,and_vel] = controller(estimatedPose);

    %Rellenar los campos del mensaje de velocidad
    msg_vel.Linear.X = lin_vel;	%Indicamos que la velocidad lineal en el eje X sea 0.1
    msg_vel.Linear.Y = 0;
    msg_vel.Linear.Z = 0;
    msg_vel.Angular.X = 0;
    msg_vel.Angular.Y = 0;
    msg_vel.Angular.Z = and_vel;
    ...
    %y estableciendo un umbral
     if (estimatedPose(1)<1 && estimatedPose(2)<1)
